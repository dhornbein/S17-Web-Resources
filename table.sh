...
<style type="text/css">
table {width:100%;}
td {border: 1px solid #ddd;margin:0;}
.res_name {}
.res_embed {}
.res_embed textarea {width:98%; height:80px; }
.res_image {}
...
for f in web*/*; do
    ...
    echo $gitPathURL$f | tr -d '/'

    facebook="<a title='share this on Facebook' href='http://www.facebook.com/sharer.php?s=100&p[url]=$gitPathURL$f&p[images][0]=$gitPathURL$f&p[title]=$shareMessage&p[summary]=$shareSummery'target='_blank'>
         <img src='http://interoccupy.net/wp-content/uploads/2012/07/1342377856_facebook-icon.png' alt='Share on Facebook' />
    </a>"
    twitter="<a href='https://twitter.com/intent/tweet?url=$gitPathURL$f&via=occupywallstNYC&text=check out this awesome graphic&hashtags=s17,ows,s17nyc&related=occupywallstNYC,occupywallst' target='_blank' title='share via Twitter'><img src='https://dev.twitter.com/sites/default/files/images_documentation/bird_blue_16.png' alt='Twitter'></a>"
    google="<a href='https://plus.google.com/share?url=$gitPathURL$f' target='_blank' title='share on Google+'><img src='https://www.gstatic.com/images/icons/gplus-16.png' alt='Google+'/></a>"
    ...
    echo "<tr>
	    ...
	    <td class='res_image'><a href='$gitPath$f' target='_blank'><img src='$f'></a></td>
    </tr>"
